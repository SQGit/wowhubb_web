      ...
      <img src="../assets/images/buss-banner.jpg" class="img-thumbnail"  alt="banner-image"/>
        	...
        	<div class='col-sm-12' style="margin:10px 0;">
         		<div class="col-md-9 text-center">
         			<h4 style="font-weight: bold;">Event Type - <?php echo $event_type; ?>
         			</h4>
    		 	</div>
     		</div>
                  ...
                  <div class='row'>
                    ...
                    <div class="form-group col-sm-6 col-md-offset-3" style="font-size: 15px;">
                      ...
                      <select name="event_totaldays" id="days" class="form-control" style="background-color:#eff0f1;">
                      	<option value="day1">1 City Events/Tour</option>
                        <option value="day1">2 Cities Events/Tours</option>
                        <option value="day2">3 Cities Events/Tours</option>
                        <option value="day3">4 Cities Events/Tours</option>
                        <option value="day4">5 Cities Events/Tours</option>
                        <option value="day5">6 Cities Events/Tours</option>
                        <option value="day6">7 Cities Events/Tours</option>
                        <option value="day7">8 Cities Events/Tours</option>
                      </select>
                    </div>
                     <div class='col-sm-12 text-center' style="margin-top:25px;">
                  		<div class="form-wizard-buttons" style="text-align:center!important;">
                    		<a class="btn btn-next" href="<?php echo base_url('event/business_event'); ?>" >Continue</a>
                  		</div>
               		 </div>
                  </div>
                </div>
