...
<div class="container"> 
  ...
  <div class="timeline">
    ...
    <div class="form-wizard-steps form-wizard-tolal-steps-7">
            ...
            <!-- Form progress --> 
            <!-- Form Step 1 -->
  		 <form id="create_event" action="<?php echo base_url('event/proffesional_single_event'); ?>"  method="post" enctype="multipart/form-data" >  
    	  <fieldset>
                <!-- Progress Bar -->
                <div class="progress">
                    ...
                    <div class='col-sm-12' style="padding: 10px 0;">
                      ...
                      <div class='form-group-1 col-sm-12'>
                        <div class="text-center" >
                          ...
                          <input type='text' name="event_title" id="wow_title" class="form-control " onkeydown="return alphaOnly(wow_title);" style="padding: 6px 30px;" placeholder="Enter Your !Wowtag Title Here      Example:  Craigsbirthday2017" />
                        </div>
                      </div>
                    </div>
                  </div>
