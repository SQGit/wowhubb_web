...
<body class="landing-page">
	<!-- loading swal for full page hide -->
	<div class="swal"></div>
...
<div class="container"> 
  ...
  <div class="timeline">
    ...
    <div class="form-wizard-steps form-wizard-tolal-steps-8">
              ...
              <!-- Step 7 -->
               <div class="form-wizard-step">
                <div class="form-wizard-step-icon"><i class="fa fa-paper-plane" aria-hidden="true"></i></div>
    	  ...
    	  <fieldset>
                ...
                <!-- Progress Bar -->
                  <div class="row" style="margin-bottom:15px;">
                     <div class="col-md-12">
                       <div class="col-md-12" style="background:#f5f5f5; padding-top:15px; padding-bottom:10px;">
                         <div class="col-md-12">
       				...
       				<div class='col-sm-5'>
                 		<div class='row'>
		                    ...
		                    <div class="form-group col-sm-12 " style="font-size: 15px;">
				                     ...
				                     <select name="eventdayscount" id="btn-add-tab" class="form-control required" >
    ...
    <fieldset> 
           ...
           <!-- Progress Bar -->
                ...
                <!-- Progress Bar -->
                   ...
                   <div class="col-md-1">
                    <div class='form-group col-sm-12'> 
                    	<a class="btn-next" href="JavaScript:void(0);"><i class="fa fa-fast-forward"></i> Skip</a> </div>
                  </div>
                     <div class="col-md-11">
                       <div class="col-md-12" style="background:#f5f5f5; padding-top:15px; padding-bottom:15px;">
		                        ...
		                        <div class="input-group col-xs-12" style="margin-top:0px;">
		                         ...
		                         <input type="file" style="display:none;" name="highlight_img1" id="video_size1" class="file">
			                     	...
			                     	<div id="video_show1" style="display: none;" >
			                     		<div class="remove_video" style="cursor: pointer; position:absolute; top: 107px; left: 210px; z-index:9999;">
		                          			<img src="<?php echo base_url('assets/images/wow-close.png'); ?>" />
		                        		</div>
	                      ...
	                      <div class="form-group">                       
	                        <div class="input-group col-xs-12" style="margin-top:0px;">
	                     	...
	                     	<div id="video_show2" style="display: none;" >
	                     		<div class="remove_video1" style="cursor: pointer; position:absolute; top: 67px; left: 210px; z-index:9999;">
		                          	<img src="<?php echo base_url('assets/images/wow-close.png'); ?>" />
		                        </div>
	                        	<video width="200" height="170" controls>
           			...
           			<div id="event_tour">
                		<div id="event_tour_1" class="tab1">                			
		                    ...
		                    <div class='form-group col-sm-6'>
		                      ...
		                      <input type='text' id="tour_startime_1" name="eventtour_startime[]" class="day_start_time form-control" autocomplete="off" />
		                    </div>
		                    ...
		                    <div class='form-group col-sm-6'>
		                      ...
		                      <input type='text' id="tour_endtiming_1" name="eventtour_endtiming[]" class="day_end_time form-control" autocomplete="off" />
		                    </div>
               ...
               <div class='col-sm-4'>
                  	<div class='row'>
                  			<div class='form-group-1 col-sm-12'>	
				                    ...
				                    <select name="tour_noof_city" class="form-control" autocomplete="off">
		                    ...
		                    <div class='form-group-1 col-sm-12' style="margin-top: 20px;">
		                      ...
		                      <div class="pull-left" style="width:90%; font-size:13px;">Public Event</div>
		                    </div>
		                    <div class='form-group-1 col-sm-12'>
			                    <div class="pull-left" style="width:10%;">
			                    ...
			                    <div class="pull-left" style="width:90%; font-size:13px;">Private Event</div>
		                    </div>
		                    <div class='form-group-1 col-sm-12'>
		                      <div class="pull-left" style="width:10%;">
            ...
            <div class="main">
                ...
                <div id="first_form" class="animated bounce"> 
                	...
                	<div class='form-group col-sm-5'>
                   		...
                   		<div class='form-group col-sm-12' style="background:#f5f5f5; padding:15px 10px; margin-top:5px;">
                    				<div class="col-md-12" style="margin-bottom:5px;"><h4>Select Your Event Promotion Options<br>
									</h4></div>
                ...
                <div id="second_form" style="display: none;" class="animated bounceInLeft"> 
                	...
                	<div class='form-group col-sm-7'>                   
                   			...
                   			<div class='form-group col-sm-12' style="background:#f5f5f5; padding:15px 10px; margin-top:5px;">
                    			<div class="col-md-12 text-center" style="margin-bottom:15px;"><h5 style="color:#e91e63; font-size:13px; font-weight:bold;">Your Audience Will Be Directed To This Link For Further Registration<br> <br>
			                    ...
			                    <div class="col-md-12" style="margin-top:15px;">
				                      ...
				                      <div style="width:95%;" class="pull-left text-left">
				                        <input type='text' name="url_donation_url"  class="form-control" placeholder="Donation URLs" autocomplete="off">
				                      </div>
			                    </div>
			                    <div class="col-md-12" style="margin-top:15px;">
				                      <div class="pull-left" style="width:5%;">
				                      ...
				                      <div style="width:95%;" class="pull-left text-left">
				                        <input type='text' name="url_website_url"  class="form-control" placeholder="Website URLs"  autocomplete="off">
				                      </div>		                      
			                    </div>
		                      	<div class="col-md-12" style="margin-top:15px;">
				                      <div class="pull-left" style="width:5%;">
				                        <input type="checkbox" name="url_donthave_link" style="width:20px; height:20px; background:white; border-radius:5px; border:2px solid #555;" autocomplete="off">
				                      </div>
				                      <div style="width:95%;" class="pull-left text-left">
                    ...
                    <div id="third_form" style="display: none;" class="animated  bounceInLeft"> 
                        ...
                        <div class='form-group col-sm-12' style="background:#f5f5f5; padding:15px 10px; margin-top:5px;">
			                    ...
			                    <div class='form-group col-sm-12 text-left' >
			                      	...
			                      	<input type='text' name="coupon_code" class="form-control" autocomplete="off" />
			                    </div>
			                    ...
			                    <div class='form-group col-sm-12 text-left' >
			                      ...
			                      <div class="input-group">
								      <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>						     
			                     	  <input type='text' name="coupon_ex_date" id="coupon_ex_date" class="form-control" autocomplete="off" />
			                      </div>
			                    </div>

			                    <div class='form-group col-sm-12 text-left' >
			                      <label>Coupon Terms &amp; Conditions</label>
			                      <textarea  name="terms_condition"  class="form-control"  style="min-height:120px;" autocomplete="off"></textarea>
			                    </div>
			                    <div class="form-group col-sm-12 ">
...
//event pgm schedule day  and event tour start and end time 
...
function update_tour() {	
    ...
    $(".tab1").each(function(index1){
        ...
        if(city != '' || ticket_url != '' || start_date != '' || end_date != '' )
        {
            ...
            var event_tour = ' <div class="form-group col-sm-12" style="background-color:#f3dae2; margin-top:10px;  border-radius:5px; "> <div class="pull-left" style="width:20%;word-wrap: break-word;">'+city+'</div>'+
...
// pass value with in same form
$('#event_endtiming').change(function() {
    $('#day1_end_time').val($(this).val());
