...
<div class="container"> 
  ...
  <div class="timeline">
    ...
    <div class="form-wizard-steps form-wizard-tolal-steps-7">
            ...
            <!-- Form progress --> 
            <!-- Form Step 1 -->
  		 <form id="create_proffesional_event" action="<?php echo base_url('event/proffesional_single_event'); ?>"  method="post" enctype="multipart/form-data" >  
    	  <fieldset>
                <!-- Progress Bar -->
                <div class="progress">
                    ...
                    <div class='col-sm-12' style="padding: 10px 0;">
                      ...
                      <div class='form-group-1 col-sm-12'>
                        <div class="text-center" >
                          ...
                          <input type='text' name="event_title" id="wow_title" class="form-control required" onkeydown="return alphaOnly(wow_title);" style="padding: 6px 30px;" placeholder="Enter Your !Wowtag Title Here      Example:  Craigsbirthday2017" />
                        </div>
                      </div>
                    </div>
                  </div>
			                        ...
			                        <div class="form-group col-md-12 text-center" style="margin-top:15px;">
			                         ...
			                         <div class="row">
			                         	<div class="form-group-1 col-md-12">
				                          ...
				                          <input type='text' id="event_date" name="quesans1"  class="form-control"  />
				                        </div>
				                        <div class="form-group-1 col-md-12">
				                          <p>This is a kids friendly event?</p>
				                          <input type='text' id="event_date" name="quesans2"  class="form-control"  />
				                        </div>
				                        <div class="form-group-1 col-md-12">
				                          <p>What are event parking/Transportantion options to and from event location?</p>
				                          <input type='text' id="event_date" name="quesans3"  class="form-control"  />
				                        </div>
				                        <div class="form-group-1 col-md-12">
				                          <p>  What are allowed into the event venue?</p>
				                          <input type='text' id="event_date" name="quesans4"  class="form-control"  />
				                        </div>
				                    </div>
...
$('#create_proffesional_event').on('keyup keypress', function(e) {
...
// this part will be show event start date connect to event no.of days
...
var base_url = '<?php echo base_url() ?>'; //form submited
    ...
    $(document).on("submit", "#create_proffesional_event", function(e){
         e.preventDefault();
