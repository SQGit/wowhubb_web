...
<div class="container"> 
  ...
  <div class="timeline">
    ...
    <div class="form-wizard-steps form-wizard-tolal-steps-7">
            ...
            <!-- Form progress --> 
            <!-- Form Step 1 -->
  		<form id="create_event" action="<?php echo base_url('event/professional_multicity_event'); ?>"  method="post" enctype="multipart/form-data" >  
    	  <fieldset>
                <!-- Progress Bar -->
                <div class="progress">
    ...
    <fieldset>
                <!-- Progress Bar -->
                <div class="progress">
                  <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="42.84" aria-valuemin="0" aria-valuemax="100" style="width: 28.56%"> </div>
                </div>
                <!-- Progress Bar -->
             	...
             	<div id="event_venues">
                	<div id="event_address_1" class="tab">                			
		                    ...
		                    <div class='form-group col-sm-6'>
		                      ...
		                      <input type='text' id="event_startdate" name="eventvenue_startdate[]"  class="event_startdate form-control "  />
		                    </div>
		                    ...
		                    <div class='form-group col-sm-12'>	
		                    	 <label>Country</label>	                      
		                      <!-- <input type='text' id="country_1" name="venue_country[]" class="form-control" placeholder="Enter your country" /> -->
 	...
 	<fieldset>
                ...
                <!-- Progress Bar -->
                <div class="progress">
                  <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="28.56" aria-valuemin="0" aria-valuemax="100" style="width: 42.84%"> </div>
                </div>
                <!-- Progress Bar -->
