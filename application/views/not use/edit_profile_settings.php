          ...
          <div class="row">
            <div class="col-md-3">
              ...
              <ul class="edit-menu">
                ...
                <li><i class="icon ion-ios-heart-outline"></i><a href="<?php echo base_url('Profile/edit_interests')  ?>">My Interests</a></li>
                <li class="active"><i class="icon ion-ios-settings"></i><a href="<?php echo base_url('Profile/edit_account_settings')  ?>">Account Settings</a></li>
