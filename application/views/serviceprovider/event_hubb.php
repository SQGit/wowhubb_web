                  ...
                  <tr>
                    ...
                    <td rowspan="2" align="left" valign="top" bgcolor="#fff"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tbody>
                          ...
                          <tr>
                            <td height="20"><strong>Event Venue</strong></td>
                            <td height="20">&nbsp;</td>
                          </tr>
                          <tr>
                            <td height="20"><strong>Event Schedule</strong></td>
                            <td height="20">&nbsp;</td>
                          </tr>
                          <tr>
                            <td height="20"><strong>Event Highlights</strong></td>
                            <td height="20">&nbsp;</td>
                          </tr>
                          <tr>
                            <td height="20"><strong>Event  Contacts /URLs</strong></td>
                            <td height="20">&nbsp;</td>
                          </tr>
                        </tbody>
                      </table></td>
                  ...
                  <tr>
                    ...
                    <td height="40" rowspan="2" align="left" valign="top" bgcolor="#f9f9f9"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tbody>
                          ...
                          <tr>
                            <td height="30"><img src="../assets/images/profile-icon.png" alt=""><strong style="font-size:22px; color:#FF7600;">100</strong></td>
                          </tr>
                          <tr>
                            <td height="30"><a href="#" data-toggle="modal" data-target=".modal-1" >Invites List</a></td>
                          </tr>
