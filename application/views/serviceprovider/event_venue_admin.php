  ...
  <div class="timeline">
    <div class="timeline-cover"> <img class="cover-pic" src="../assets/images/sha-1.jpg" style="background-size:cover; width:100%; margin-top:20px;" > <br>
      ...
      <div class="timeline-nav-bar hidden-sm hidden-xs">
        <div class="row">
          <div class="col-md-3">
            <div class="profile-info"> <img  src="../assets/images/sharaton-logo.jpg" class="profile-pic img-responsive profile-photo" /> </div>
          </div>
          <div class="col-md-9" >
                                  ...
                                  <ul class="nav nav-tabs">
                                    <li style="width:100%;" class="active"><a href="#b1" data-toggle="tab" style="background-color:transparent; color:#333; text-align:left; font-size:14px;">
                                      <div class="row">
                                        ...
                                        <div class="col-md-6"><img src="../assets/images/em.png" class="img-circle img-thumbnail"><br>
                                    ...
                                    <li style="width:100%;"><a href="#b" data-toggle="tab" style="background-color:transparent; color:#333; text-align:left; font-size:14px;">
                                      <div class="row">
                                        <div class="col-md-12 text-center" style="margin-bottom:15px;"><strong>Venue Inquiry</strong></div>
                                        <div class="col-md-6"><img src="../assets/images/td.png" class="img-circle img-thumbnail"><br>
                                        ...
                                        <tbody>
                                          <tr>
                                            <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tbody>
                                                  <tr>
                                                    <td width="23%" rowspan="2" align="center" valign="top" bgcolor="#F7F7F7"><img src="../assets/images/em.png" class="img-circle img-thumbnail"><br>
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td align="center" valign="top">Outdoor<img src="../assets/images/tick.png" width="12" height="9" alt=""/><br>
                                                      Indoor</td>
                                        ...
                                        <tbody>
                                          <tr>
                                            <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tbody>
                                                  <tr>
                                                    <td width="23%" rowspan="2" align="center" valign="top" bgcolor="#F7F7F7"><img src="../assets/images/td.png" class="img-circle img-thumbnail"><br>
