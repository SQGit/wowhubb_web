      ...
      <div class="container post-content">
        ...
        <div class="col-md-6">
          <div class="row">
            ...
            <div class="col-md-2 text-right" style="margin-top:20px;"><a href="#"><i class="fa fa-2x fa-map-marker"></i></a></div>
         ...
         <div class="col-md-6">
          ...
          <div class="row">
            <div class="col-md-12" style="margin-top:10px;">
              <div class="gallery"> <img src="<?php echo base_url('assets/images/cake/cake2.jpg'); ?>" alt="post-image" class="img-responsive img-thumbnail" /> <br> 3000 Wowsomes</div>
            </div>
            <div class="col-md-12" style="margin-top:10px;">
              <p style="font-size:16px;">2345, Blue Street, Sugarland Texas 77334<br>
                Opens @7:00pm<br>
         ...
         <div class="col-md-6">
          ...
          <div class="row">
            <div class="col-md-12" style="margin-top:10px;">
              <div class="gallery"> <img src="<?php echo base_url('assets/images/cake/cake4.jpg'); ?>" alt="post-image" class="img-responsive img-thumbnail" /> <br> 3000 Wowsomes</div>
            </div>
            <div class="col-md-12" style="margin-top:10px;">
              <p style="font-size:16px;">2345, Blue Street, Sugarland Texas 77334<br>
                Opens @7:00pm<br>
        ...
        <div class="col-md-6">
          ...
          <div class="row">
            <div class="col-md-12" style="margin-top:10px;">
              <div class="gallery"> <img src="<?php echo base_url('assets/images/cake/cake3.jpg'); ?>" alt="post-image" class="img-responsive img-thumbnail" /> <br> 3000 Wowsomes</div>
            </div>
            <div class="col-md-12" style="margin-top:10px;">
